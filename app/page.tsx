...
const birthdayMessages = [
  ...
  "병준아 항상 건강해라.",
  "병준아 태어난 걸 진심으로 축하한다.",
  "병준아 오늘은 마음껏 맛있는 거 먹어라.",
  "병준아 만 19세 된 걸 축하한다.",
  "병준아 딜러 꼭 그랜드마스터 찍어라.",
  "병준아 경쟁전에서 팀운도 좀 따라주길 바란다.",
  "병준아 바이크 탈 땐 안전운전이 제일이다.",
  "병준아 헬멧은 귀찮아도 꼭 쓰고 다녀라.",
  "병준아 언젠가는 F1 드라이버가 되길 응원한다.",
  "병준아 출근하다 허리 나가지 말고 스트레칭도 좀 해라.",
  "병준아 야근은 적게 하고 월급은 많이 받아라.",
  "병준아 올해는 하는 일마다 잘 풀렸으면 좋겠다.",
  "병준아 로또 1등 되면 나도 기억해라.",
  "병준아 내일 생일빵은... 유감이다.",
  "병준아 오늘만큼은 세상 주인공이다.",
  "병준아 앞으로도 오래오래 친구 하자.",
  "병준아 웃을 일만 가득했으면 좋겠다.",
